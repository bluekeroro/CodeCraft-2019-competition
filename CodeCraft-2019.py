...
def main():
    ...
    param = [
# turning 1     2     3     4    5
        [0.008, 0.02, 0.03, 0.2, 0.2], # speed == 16
        [0.008, 0.02, 0.03, 0.2, 0.2], # speed == 14
        [0.008, 0.02, 0.03, 0.2, 0.2], # speed == 12
        [0.01, 0.03, 0.04, 0.2, 0.2], # speed == 10
        [0.01, 0.03, 0.04, 0.2, 0.2], # speed == 8
        [0.01, 0.03, 0.04, 0.3, 0.3], # speed == 6
        [0.01, 0.03, 0.04, 0.3, 0.3], # speed == 4
    ]
